...
void setup() {
  ...
  G4P.setCursor(ARROW);
  btnToggle2 = new GImageToggleButton(this, 350, 250, "s2.png", "s3.png", 4, 4);
...
public void handleToggleButtonEvents(GImageToggleButton button, GEvent event) { 
  ...
  switch(state) {
    ...
    case(2):background(0, 200, 140,200);break;
    case(3):background(0, 128, 255,200);break;
    case(4):background(50,128);break;
    case(5):background(0,200);break;
    case(6):background(255,0,0,200);break;
    case(7):background(0, 200, 140,200);break;
    case(8):background(0, 128, 255,200);break;
    case(9):background(50,128);break;
    case(10):background(0,200);break;
    case(11):background(255,0,0,200);break;
    case(12):background(0, 200, 140,200);break;
    case(13):background(0, 128, 255,200);break;
    case(14):background(50,128);break;
    case(15):background(50,128);break;
    case(16):background(50,128);break;
  }
}
